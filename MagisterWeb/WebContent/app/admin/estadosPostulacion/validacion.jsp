...
<c:if test='${user.hasPermisos("RECHAZAR_DOC")}'>
	...
	<form action="rechazo" method="get" onsubmit="return (function(){if($('#id_documentos1').val()===''){alert('Debe seleccionar al menos un documento para rechazarlo.'); return false;} else return confirm('Al realizar esta acción se le notificará vía email al postulante. Además la postulación será envíada de vuelta a Revisión,\n ¿Desea continuar?')})()">
