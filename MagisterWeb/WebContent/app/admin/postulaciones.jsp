...
%>
<%
	pageContext.setAttribute("rechazado",
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span9" id="content">
				...
				<div class="row-fluid">
					<h1>
						Postulaciones <small>Magister en TI</small>
					</h1>
				</div>
				<div class="row-fluid">
					<div class="alert alert-success fade in"
						${param.exito!=null ? '' : 'hidden' }>

						<button class="close" data-dismiss="alert" type="button">×

						</button>
						<strong> Operacion Exitosa </strong> Los datos han sido procesados
						de manera correcta.
				...
				<div class="row-fluid">
					<div class="alert alert-success fade in"
						${param.nuevaC!=null ? '' : 'hidden' }>

						<button class="close" data-dismiss="alert" type="button">×

						</button>
						<strong> Operacion Exitosa </strong> La Contraseña se ha cambiado
						correctamente
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<ul class="nav">
							...
							<li><a href="#resolucion" data-toggle="tab">Resuelta <span
									class="badge badge-info">${postulacionesResolucion.size()}</span>
							</a></li>
						</ul>
					</div>
