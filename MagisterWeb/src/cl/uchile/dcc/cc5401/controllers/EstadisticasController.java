...
public class EstadisticasController extends HttpServlet {
	...
	private static String ESTADISTICAS_PAGE ="/app/admin/estadisticas.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			request.setAttribute("mapGenero", estadisticasDAO.getEstadisticaGenero());
			request.setAttribute("mapResoluciones", estadisticasDAO.getEstadisticaResolucion());
			request.setAttribute("mapFinanciamiento", estadisticasDAO.getEstadisticaFinanciamiento());
			request.setAttribute("mapNacionalidad", estadisticasDAO.getNacionalVsExtranjeros());
			
			HashMap<String,Integer> mapPPM = estadisticasDAO.getPostulacionesAlMes(9, 2013);
