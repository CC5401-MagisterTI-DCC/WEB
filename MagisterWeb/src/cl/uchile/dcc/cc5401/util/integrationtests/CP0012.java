...
public class CP0012 extends IntegrationTest {
	...
	@Test
	public void postulacionRechazadaPorDocumentoIndicadoTest()
			throws SQLException, FailingHttpStatusCodeException,
		...
		HtmlPage page = webClientSecretaria
				.getPage("http://localhost:8080/MagisterWeb/"
						+ "app/admin/rechazo?id_documentos1=" + documentos
						+ "&id_postulacion=" + idPostulacion + "&comentario="
						+ comentario);
